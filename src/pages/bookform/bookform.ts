...
export class BookformPage {
    ...
    ionViewDidLoad() {
        if (this.bookID != '') {
            this.http.get('http://localhost/~imam/ionic_web_server/detail_buku.php', {id: this.bookID}, this.header)
            .then((res) => {
                try {
    ...
    save() {
        if (this.book.judul == '' || this.book.penerbit == '' || this.book.pengarang == '') {
            ...
            var url = 'http://localhost/~imam/ionic_web_server/tambah_buku.php';
            if (this.bookID) {
                url = 'http://localhost/~imam/ionic_web_server/edit_buku.php'
            }
    ...
    deleteBook() {
        var url = 'http://localhost/~imam/ionic_web_server/delete_buku.php';
